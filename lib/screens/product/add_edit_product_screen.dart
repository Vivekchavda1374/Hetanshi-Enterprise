                      ...
                      children: [
                            ...
                            child: Container(
                              ...
                              child: (_selectedImage == null && _currentImageUrl.isEmpty)
                                  ? Column(
                                      ...
                                      children: [
                                        Icon(Icons.add_a_photo_rounded, size: 40, color: AppColors.primaryBlue.withOpacity(0.5)),
                        ...
                        if (_selectedImage != null && kIsWeb)
                           Padding(
                             ...
                             child: Text("New image selected", style: TextStyle(color: AppColors.successGreen, fontSize: 12)),
                           ),
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                ...
                                validator: (value) => value == null || value.isEmpty ? 'Enter MRP' : null,
                              ),
                            ),
                            ...
                            Expanded(
                              child: TextFormField(
                                ...
                                keyboardType: TextInputType.number,
                                validator: (value) => value == null || value.isEmpty ? 'Enter Rate' : null,
                              ),
                            ),
                          ],
                        ),
